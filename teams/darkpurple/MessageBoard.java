...
public class MessageBoard {
	...
	static final int HARASS_DRONE_COUNT = 20;
	...
	static final BuildItem[] oldBuildOrder2 = new BuildItem[]
			{
		new BuildItem(RobotType.BEAVER, 1), 
		new BuildItem(RobotType.MINERFACTORY, 1),
		new BuildItem(RobotType.BEAVER, 1),
	...
	static final BuildItem[] soldierBuildOrder = new BuildItem[]
			{
		new BuildItem(RobotType.BEAVER, 1), 
		new BuildItem(RobotType.MINERFACTORY, 1),
		new BuildItem(RobotType.BEAVER, 1),
	...
	static BuildItem[] currentBuildOrder = soldierBuildOrder;
