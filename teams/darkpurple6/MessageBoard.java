...
public class MessageBoard {
	...
	public static final int TANKS_PER_WAVE = 12;
	...
	public static final boolean BARRACKS_CAN_BUILD = false;
	static final BuildItem[] sprintBuildOrder = new BuildItem[]
		...
		new BuildItem(RobotType.TANKFACTORY, 2),
		new BuildItem(RobotType.SUPPLYDEPOT, 4),
